...
# training data
train_dataset = SuperResolutionDataset(lr_dir=r'Datasets\DIV2K_train_LR_unknown_X2\DIV2K_train_LR_unknown\X2', hr_dir=r'Datasets\DIV2K_train_HR\DIV2K_train_HR', scale_suffix='x2', transform=transform)
validation_dataset = SuperResolutionDataset(lr_dir=r'Datasets\DIV2K_valid_LR_unknown_X2\DIV2K_valid_LR_unknown\X2', hr_dir=r'Datasets\DIV2K_valid_HR\DIV2K_valid_HR', scale_suffix='x2', transform=transform)
# validation data
...
def plot_metrics(train_losses, val_losses, val_psnrs):
    ...
    plt.ylabel('Loss')
    plt.legend()
    plt.savefig("Task 2 result L1 loss funcion .png")
    ...
    plt.ylabel('PSNR')
    plt.legend()
    plt.savefig("Task 2 result PSNR loss funcion .png")
# plot images
...
test_dataset = SuperResolutionDataset(
    lr_dir=r'Datasets\DIV2K_valid_LR_bicubic_X2\DIV2K_valid_LR_bicubic\X2',
...
def show_prediction_comparison(model, data_loader, num_pairs, device):
    ...
    plt.tight_layout()
    plt.savefig("Task 2 prediction_comparison .png")
